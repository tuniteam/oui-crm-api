...
- Handoff front : écran V8 = Paramètres › Rôles et droits (`SETPANE.roles`, `openRoleModal`, `dupRole`). La matrice 13 objets × 5 verbes de la V8 se rend depuis `GET /permissions` groupé par `module`.
